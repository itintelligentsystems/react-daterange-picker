            ...
            React__default.createElement(Grid, null,
                React__default.createElement(Grid, { container: true, className: classes.calendarHeader, alignItems: "center" },
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(Typography, { variant: "subtitle1" }, startDate ? format(startDate, dateFormat) : translationText === null || translationText === void 0 ? void 0 : translationText.startDate)),
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(ArrowRightAlt, { color: "action" })),
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(Typography, { variant: "subtitle1" }, endDate ? format(endDate, dateFormat) : translationText === null || translationText === void 0 ? void 0 : translationText.endDate))),
